 ...
 * @author 1300180
 */
public class ListItemPanal extends Application  {
...
//        
        ...
        hBox.setSpacing(10);
        hBox.getChildren().addAll(nameInput,IDInput, PriceInput, ExpiredDateInput, QuantityInput);
        table = new TableView<>();
    ...
    public ObservableList<item> getitem(){
        ...
        items.add(new item("laptops", "1001",24999.99, null, 110));
        items.add(new item("Mobile phones", "1002",10000, null, 250));
        items.add(new item("Mobile Cover", "1003",60, null, 50));
        items.add(new item("Laptop Cover", "1004",100, null, 270));
        items.add(new item("HeadPhones", "1005",250, null, 320));
        return items;
    }
